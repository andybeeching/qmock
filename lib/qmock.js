...
;(function ( container ) {
  ...
  function createQMock () {
    ...
    // DOCS: QMock.utils.enumerate( obj, fn[, context][, bool] ) -> Object
    function enumerate ( obj, fn, context, bool ) {
      for ( var key in obj ) {
    ...
    // DOCS: QMock.utils.iterate( obj, fn[, context] ) -> Array || Collection
    ...
    // DOCS: bindInterface( obj, receiver, context )
    function bindInterface ( target, obj, context ) {
      enumerate(obj, function( prop, key ) {
        if ( typeof prop == "function" ) {
          target[ key ] = bind( prop, context );
        }
      });
    }
