...
;(function ( container ) {
  ...
  // Trap original methods & reduce lookups in a protected scope
  ...
  function createQMock () {
    ...
    // DOCS: QMock.utils.enumerate( obj, fn[, scope][, bool] ) -> Object
    ...
    // DOCS: QMock.utils.iterate( obj, fn[, scope] ) -> Array || Collection
    ...
    // DOCS: bindInterface( obj, receiver, scope )
